 ...
 */
export function listingTokens(name: string, description: string | null): number {
  if (description === null) return SKILL_PROMPT_OVERHEAD_TOKENS;
...
export function listingTokensFromContent(name: string, content: string): number {
