...
function classifyIssues(localSkills, pluginSkills, brokenSymlinks, memoryFiles) {
    const issues = [];
...
export async function scan() {
    const [{ skills: localSkills, brokenSymlinks }, { skills: pluginSkills, plugins }, memoryFiles, mcpServers,] = await Promise.all([
        scanLocalSkills(),
        scanPluginSkills(),
        scanMemoryFiles(),
        countMcpServers(),
